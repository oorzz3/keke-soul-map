...
- v0.5.1.3 首頁 Blueprint 視覺二修後，農民曆與神明生日維持短卡化 support card，不進入命盤核心主視覺。
- 本版只文件化現況。
...
- v0.5.1.3 已配合首頁 Blueprint 視覺二修，農民曆只保留短卡摘要與 anchor
...
- v0.5.1.3 首頁只保留短卡化 support 摘要，不新增農民曆 detail route
...
- v0.5.1.3 首頁 Blueprint 視覺二修（已啟動）
