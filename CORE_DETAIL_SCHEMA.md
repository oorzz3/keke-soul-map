...
- v0.6.2.1 首頁 rhythm row 改用「今日數字節奏」，但 #/module/numerology 詳情頁的 calculated panel、static interpretation panel 與 safety lines 保持不變。
...
- v0.6.2.1 不改 `features/numerology-calculator.js` 計算邏輯。
