...
function checkCoreAlgorithmBoundary() {
  ...
  checkIncludes("NAME_STROKE_SEED_PLAN.md", seedPlan, [
    { label: expectedVersionLabel, value: expectedVersionLabel },
    { label: "姓名學", value: "姓名學" },
    { label: "planning", value: "planning" },
    { label: "not-calculated", value: "not-calculated" },
    ...
    { label: "variantGroup", value: "variantGroup" },
...
function checkNameMetadataBoundary() {
  ...
  [
    ...
    { label: "index.html 不引用 name stroke seed", content: index, value: "data/name-stroke-seed.js" },
